...
import { storeMachine, StoreService } from '@/lib/storeMachine';
 ...
 */
import services from '@/lib/commercejs/storeMachine/services';

/**
 * Action and Guard imports
 *
 * Actions and guards are machine specific functions are imported
 * from the storeMachine folder and assigned to the machine
 */
import actions from '@/lib/storeMachine/actions';
import guards from '@/lib/storeMachine/guards';
